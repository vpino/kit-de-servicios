...
from kds.common.utils import get_path, find_files, find_dirs
...
class clean_man(Command):
    ...
    def run(self):
        man_file = get_path([DOCDIR, 'man', 'kds.1'])
...
class clean_dist(Command):
    ...
    def run(self):
        for dist_dir in ['dist', 'build', 'kds.egg-info']:
